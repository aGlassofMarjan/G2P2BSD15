            ...
            <div className="flex w-screen h-screen justify-center items-center bg-gray-100">
                <div className="p-8 flex bg-white rounded-3xl">
                    ...
                    <div className="block w-96 mt-24">
                        ...
                        <input className="mb-5 py-2 px-4 w-full border-2 rounded-lg" type="text" name="" id="" placeholder="Input your image"/>
                        ...
                        <div className="flex justify-end mt-5">
                            <Link to='/login'><button className="hover:bg-blue-100 mr-5 hover:rounded-3xl px-6 py-2">Sign in</button></Link>
